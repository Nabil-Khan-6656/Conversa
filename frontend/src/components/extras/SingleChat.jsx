...
import { getSender , getSenderFull , isSameUser} from '../../config/ChatLogics'
...
const ENDPOINT = "https://conversa-test.vercel.app"
        ...
        selectedChat ? (
            ...
            >
              ...
              <FormControl display='flex'  onKeyDown={ sendMessage} isRequired mt={3}>
                ...
                value={newMessage}
                />
              <Button onClick={sendTheMessage}><i class="fa-solid fa-paper-plane"></i></Button>
              </FormControl>
